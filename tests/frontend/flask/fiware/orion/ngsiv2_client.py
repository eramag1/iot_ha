...
if __name__ == '__main__':
    ...
    client.set_source_ip(SOURCE_IP_1)

    test_entity_id = "prueba24"

    print(client.get_entities())

    print(client.create_entity(id=test_entity_id, temperature="10", pressure="100"))

    print(client.get_entity(entity_id=test_entity_id))

    print(client.get_entity_attrs(entity_id=test_entity_id))

    print(client.set_entity_attrs(entity_id=test_entity_id, temperature="20", pressure="200"))

    print(client.get_entity_attrs(entity_id=test_entity_id))

    print(client.delete_entity(entity_id=test_entity_id))
